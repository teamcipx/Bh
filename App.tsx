  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-[var(--tg-bg)] text-[var(--tg-text)] p-8 text-center">
        ...
        <p className="text-gray-400 mt-2 font-bold uppercase text-[10px] tracking-widest">Secure Handshake...</p>
      </div>
    );
  }
    ...
    <div className="max-w-md mx-auto min-h-screen bg-[var(--tg-bg)] text-[var(--tg-text)] relative pb-20 overflow-x-hidden select-none">
      <header className="sticky top-0 z-[60] px-5 py-4 flex items-center justify-between border-b border-gray-100 dark:border-gray-800/50 backdrop-blur-xl bg-white/70 dark:bg-black/70 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              <span className="text-[8px] font-black uppercase text-green-500 tracking-widest">Network Live</span>
            </div>
          </div>
        </div>
        ...
        <div 
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 text-blue-600 border border-blue-100 dark:border-blue-800/50 rounded-2xl shadow-sm active:scale-95 transition-all"
        >
          <span className="font-black text-sm tracking-tight">{(user.balance ?? 0).toLocaleString()}</span>
          <div className="w-5 h-5 bg-blue-600 rounded-full flex items-center justify-center shadow-inner">
      ...
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white/80 dark:bg-black/80 backdrop-blur-xl border-t border-gray-100 dark:border-gray-800 px-2 py-4 flex justify-around items-center z-[70]">
        {[
          { id: 'home', label: 'Dashboard', icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} /></svg> },
          { id: 'chat', label: 'Inbox', icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg> },
          { id: 'referral', label: 'Invite', icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} /></svg> },
